...
public partial class @PlayerControls: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ""name"": ""Dragging"",
            ""id"": ""0eb7c7fc-5bab-4cf1-989d-6be8d114fdec"",
            ""actions"": [
                {
                    ""name"": ""Press"",
                    ""type"": ""Button"",
                    ""id"": ""9b2cd11e-04f7-46d4-88ab-f28b8ccd6474"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                ...
                },
                {
                    ""name"": ""Position"",
                    ""type"": ""Value"",
                    ""id"": ""cc36079b-9b60-4447-9b38-6c88ad8d6cbe"",
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""4a40b250-16c0-4fc6-a7eb-b1063d39cabf"",
                ...
                {
                    ""name"": """",
                    ""id"": ""2ba38d29-8376-42f7-aca9-bf93a07fd944"",
                    ""path"": ""<Mouse>/position"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ~@PlayerControls()
    {
        UnityEngine.Debug.Assert(!m_Dragging.enabled, "This will cause a leak and performance issues, PlayerControls.Dragging.Disable() has not been called.");
    }
    ...
    /// <summary>
    /// Provides access to input actions defined in input action map "Dragging".
    /// </summary>
    public struct DraggingActions
    {
        ...
        /// </summary>
        public DraggingActions(@PlayerControls wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "Dragging/Press".
        /// </summary>
        public InputAction @Press => m_Wrapper.m_Dragging_Press;
        /// <summary>
        /// Provides access to the underlying input action "Dragging/Position".
        /// </summary>
        ...
        /// <summary>
        /// Implicitly converts an <see ref="DraggingActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="DraggingActions.UnregisterCallbacks(IDraggingActions)" />.
        /// </summary>
        /// <seealso cref="DraggingActions.UnregisterCallbacks(IDraggingActions)" />
        ...
        /// </remarks>
        /// <seealso cref="DraggingActions.AddCallbacks(IDraggingActions)" />
        /// <seealso cref="DraggingActions.RemoveCallbacks(IDraggingActions)" />
        /// <seealso cref="DraggingActions.UnregisterCallbacks(IDraggingActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="DraggingActions" /> instance referencing this action map.
    /// </summary>
    public DraggingActions @Dragging => new DraggingActions(this);
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "Dragging" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="DraggingActions.AddCallbacks(IDraggingActions)" />
    /// <seealso cref="DraggingActions.RemoveCallbacks(IDraggingActions)" />
